<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap['desc']" :visible.sync="descFormVisible" width="900px">
...
import { approveOrder, getOrder, rejectOrder } from '@/api/purchase'
