<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="供应商名称" min-width="225" align="center">
      ...
      <el-table-column label="联系方式" width="340" align="center">
        <template slot-scope="{row}">
          <span>{{ row.phone }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="form" label-position="left" label-width="100px" style="width: 400px; margin-left:40px;">
...
import { addSupplier, delSupplier, getSupplier, modSupplier } from '@/api/related'
...
export default {
  ...
  methods: {
    ...
    handleDelete() {
      ...
      console.log(delData)
      delSupplier(delData).then(response => {
        this.$notify({
          title: 'Success',
